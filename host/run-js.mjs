...
const app = await WebAssembly.instantiate(
  await WebAssembly.compile(await readFile(join(root, 'build', 'app-simd-js.wasm'))),
  go.importObject);

kernel = (await WebAssembly.instantiate(
  await WebAssembly.compile(await readFile(join(root, 'build', 'kernel.wasm'))),
  { env: { memory: app.instance ? app.instance.exports.mem : app.exports.mem } })).exports;
